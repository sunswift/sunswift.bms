...
#endif
#define THIS_DEVICE_TYPE       BMS//BMS

/* Number of channels */
#define NUM_IN_CHANNELS		BMS_NUM_IN_CHANNELS//BMS_NUM_IN_CHANNELS
#define NUM_OUT_CHANNELS 	BMS_NUM_OUT_CHANNELS//BMS_NUM_OUT_CHANNELS
...
#define SCANDAL_ADDRESS_OVERRIDE				BMS_HIGHER_ADDRESS //BMS_LOWER_ADDRESS (30) or BMS_HIGHER_ADDRESS (31) //Pick the address you want for the node here
